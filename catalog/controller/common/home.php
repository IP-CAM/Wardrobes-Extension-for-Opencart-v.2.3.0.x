...
class ControllerCommonHome extends Controller {
	public function index() {
        ...
        $comments = array(
            ['name' => 'Алёна Соболева', 'reference' => 'vk', 'text' => 'Купила шкаф-купе в магазине «Центр Мебели» и не пожалела о том, что выбрала их. Цены ниже чем на других сайтах, качество, а также своевременная доставка. Сам шкаф большой и вместительный, всё работает. Выполнили мои пожелания и рекомендации. Вся семья довольна... посоветую всем своим подругам!'],
            ['name' => 'Иван Савельев', 'reference' => '', 'text' => 'Был потрясён большим количеством цветов и материалов. Позвонил. Меня консультировала менеджер Наташа, очень любезная девушка, которая подобрала дизайн дверей-купе и посчитала стоимость. Купил шкаф-купе - очень здорово. Настоящие профессионалы своего дела!'],
