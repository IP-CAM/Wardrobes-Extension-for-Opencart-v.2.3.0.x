<div class="border-gray list-group line-dark-before">
	<h4>Мебель</h4>
	<div class="body">
...
<div class="border-gray text-center slider">
	<p class="font-size-18 font-type-georgia">Минимальная цена (руб.)</p>
	<div id="input-slider">
