...
$_['text_calculator_main']           = 'стр. "Калькулятор"';
$_['text_calculator_settings']       = 'Настройки страницы "Калькулятор"';
$_['text_aboutcompany_main']         = 'стр. "О компании"';
$_['text_aboutcompany']              = 'Настройки страницы "О компании"';
$_['text_contacts_main']             = 'стр. "Контакты"';
$_['text_contacts']                  = 'Настройки страницы "Контакты"';
$_['text_generalcatalog_main']       = 'стр. "Главный каталог"';
$_['text_generalcatalog']            = 'Настройки страницы "Главный каталог"';
$_['text_special_main']              = 'стр. "Акции"';
$_['text_special']                   = 'Настройки страницы "Акции"';
$_['text_review_main']               = 'стр. "Отзывы"';
$_['text_review']                    = 'Отзывы';
$_['text_review_settings']           = 'Настройки страницы "Отзывы"';
