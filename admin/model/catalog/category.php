...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		...
		foreach ($data['category_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "category_description SET category_id = '" . (int)$category_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', description = '" . $this->db->escape($value['description']) . "', description_down = '" . $this->db->escape($value['description_down']) ."', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
		}
	...
	public function getCategoryDescriptions($category_id) {
		...
		foreach ($query->rows as $result) {
			$category_description_data[$result['language_id']] = array(
                ...
                'description_down'      => $result['description_down'],
