...
class ControllerContactsContacts extends Controller {
	...
	public function index() {
		$this->load->language('contacts/contacts');
	...
	protected function getForm() {
       ...
       // $this->document->addStyle('admin/view/javascript/summernote/summernote.css');
		...
		$data['action'] = $this->url->link('contacts/contacts/edit', 'token=' . $this->session->data['token'], true);
    ...
    public function edit()
    {
        ...
        $this->model_contacts_contacts->editContacts('0', $this->request->post);
